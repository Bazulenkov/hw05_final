...
class TestHW04(TestCase):
    ...
    def test_new_post_display(self):
        ...
        post = Post.objects.create(
            text="You are talking about things I have not done yet in the past tense.", author=self.user)
...
class TestSprint6(TestCase):
    def setUp(self):
        ...
        self.post = Post.objects.create(
            text="It is driving me crazy!", author=self.user, group=self.group, image='posts/cent5.jpg')
    ...
    def test_wrong_image(self):
        ...
        error_message = response.context['form'].fields['image'].error_messages['invalid_image']
    ...
    def test_comment(self):
        ...
        self.assertFalse(self.post.comment_post.filter(
